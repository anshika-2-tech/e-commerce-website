...
displaywomenitems(items);
function displaywomenitems(data){
    let womenitemsContainerElement = document.querySelector('.women-container');
    let innerHTML = '';
...
womenitemsContainerElement.innerHTML=innerHTML;          
}
function sortLowToHigh(){
    let sortedItems=[...items];
    sortedItems.sort((a,b) => a.current_price-b.current_price);
    displaywomenitems(sortedItems);
    console.log("clicked");
}
